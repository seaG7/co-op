...
namespace HSR.NPRShader.Editor.MaterialGUI.Drawers
{
    internal class HSRMaterialIDPropertyDrawer : MaterialPropertyDrawer
    {
        ...
        public bool GetFoldoutState(MaterialEditor editor)
        {
            ...
            {
                UnityEngine.Rendering.ShaderPropertyType.Float => (int)property.floatValue == 1,
                UnityEngine.Rendering.ShaderPropertyType.Range => (int)property.floatValue == 1,
                UnityEngine.Rendering.ShaderPropertyType.Int => property.intValue == 1,
                _ => false
            };
        }
    }
