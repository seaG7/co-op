...
namespace HSR.NPRShader.Editor.MaterialGUI.Drawers
{
    internal class HSRMaterialIDFoldoutDrawer : MaterialPropertyDrawer
    {
        public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
        {
            ...
            {
                if (prop.propertyType is UnityEngine.Rendering.ShaderPropertyType.Float or UnityEngine.Rendering.ShaderPropertyType.Range)
                {
                ...
                else if (prop.propertyType is UnityEngine.Rendering.ShaderPropertyType.Int)
                {
                    EditorGUI.BeginChangeCheck();
